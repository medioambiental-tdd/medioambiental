       ...
       operaciones.getDatoMunicipio(req.params.municipio,function(mm){
        if(mm=='No existe tal municipio'){
            ...
            var json = {
                ...
                velocidadViento: [  {periodo:"00-06",valor:mm.getVelocidadViento()[0]},
                ...
                direccionViento:[   {periodo:"00-06",valor:mm.getDireccionViento()[0]},
